...
森林生態学では樹木を対象とした研究が数多く行われてきた一方で、木本性ツル植物（lianas）については、分布、個体群動態、森林における役割など、まだ十分に解明されていないことが多く残されています。しかし、ツル植物は森林の構造や更新に大きな影響を与える重要な構成要素です。

私は、ツル植物が森林内でどのように分布し、クローン繁殖によって個体を維持・拡大し、森林撹乱や長期的な森林変化に応答するのかを研究しています。野外調査、長期森林モニタリング、空間解析、遺伝解析を組み合わせることで、樹木を中心に構築されてきた森林生態学の理解を広げることを目指しています。

## ツル植物の分布と生育環境

ツル植物は、樹木を支持体として利用しながら林冠へ成長します。私は温帯林を対象に、ツル植物の分布と、地形、森林構造、ホスト（宿主）樹木、林冠ギャップなどとの関係を研究してきました。

これらの研究から、ツル植物の分布や成長様式は種によって異なり、森林内の環境や利用するホスト樹木と密接に関係することを明らかにしてきました。
...
ツル植物は、倒木などの森林撹乱によって形成される明るい環境（林冠ギャップ）の形成後に急速に増加することがあります。しかし、その増加が種子からの新規加入によるのか、それとも既存個体のクローン繁殖（栄養成長）によるのかは十分に分かっていません。

現在は、長期森林調査と遺伝解析を組み合わせ、撹乱後のツル植物の増加をもたらす過程を研究しています。また、樹木群集とツル植物群集の長期変化を比較することで、ツル植物の動態を森林全体の変化の中で理解することを目指しています。
...
ツル植物の研究に加えて、樹木の成長や材質に関する遺伝的変異と環境応答についても研究してきました。共通圃場試験や遺伝解析を用いて、樹木の形質が遺伝的背景や生育環境によってどのように変化するかを調べています。

関連する研究
- Mori et al. (2022) Genotype-by-environment interaction and genetic dissection of heartwood color in Cryptomeria japonica based on multiple common gardens and quantitative trait loci mapping. 
- Mori et al. (2020) Climate sensitivity of Cryptomeria japonica in two contrasting environments: Perspectives from QTL mapping.
- Mori et al. (2019) Mapping quantitative trait loci for growth and wood property traits in Cryptomeria japonica across multiple environments. 
